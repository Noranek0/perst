...
public interface Storage {
    ...
    /**
     * Create new peristent set based on hash table. Unlike set created by createSet which is based on OID, this set if based on hashCode()/equals() methods
     ...
     * </TD></TR>
     * <TR><TD><code>perst.xml.date.format</code></TD><TD>String</TD><TD>"EEE, d MMM yyyy kk:mm:ss z"</TD>
     * <TD>Date format used for XML export/import. By default HTTP date format is used.
     * </TD></TR>     
     * <TR><TD><code>perst.xml.reuse.oid</code></TD><TD>bool</TD><TD>false</TD>
     * <TD>Reuse OID of objects during XML import
     * </TD></TR>     
     * </TABLE>
